...
<p align="center">
  <a href="https://github.com/DorukTan/unity-supabase/releases/tag/v0.2.0-beta.5"><img alt="Release" src="https://img.shields.io/badge/release-0.2.0--beta.5-3ecf8e" /></a>
  <a href="https://github.com/DorukTan/unity-supabase/releases/download/v0.2.0-beta.5/com.supabaseunity.client-0.2.0-beta.5.unitypackage"><img alt="Download unitypackage" src="https://img.shields.io/badge/download-.unitypackage-3ecf8e?logo=unity&amp;logoColor=white" /></a>
...
```text
https://github.com/DorukTan/unity-supabase.git?path=/Packages/com.supabaseunity.client#v0.2.0-beta.5
```

✅ **Done.** Newtonsoft Json.NET comes with it automatically.

Prefer a file download? The
[latest release](https://github.com/DorukTan/unity-supabase/releases/tag/v0.2.0-beta.5)
also includes:
